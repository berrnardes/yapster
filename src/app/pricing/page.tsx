		...
		<MaxWidthWrapper className="mb-8 mt-24 text-center max-w-5xl">
			<div className="mx-auto mb-10 sm:max-w-lg">
				<h1 className="text-5xl font-bold sm:text-6xl text-zinc-800">
					Planos <span className="text-sky-600">&</span> Preços
				</h1>
				<p className="mt-5 text-zinc-600 sm:text-lg">
					Comece a aprender hoje e libere o verdadeiro potencial do aprendizado
				</p>
			</div>
						...
						return (
							<div
								...
								className={cn("relative rounded-2xl bg-white shadow-lg", {
									"border border-sky-600 shadow-sky-200": plan === "Pro",
									"border border-zinc-200": plan !== "Pro",
								})}
							>
								{plan === "Pro" && (
									<div className="absolute -top-5 left-0 right-0 mx-auto w-32 rounded-full bg-gradient-to-r from-sky-600 to-cyan-500 px-3 py-2 text-sm font-medium text-white">
										Comece agora
									</div>
								)}
									...
									<div className="flex items-center space-x-1">
										...
										<Tooltip delayDuration={300}>
											...
											<TooltipContent className="w-80 p-2 ">
												Quantidade de PDFs disponíveis para você fazer o upload
												no mês
											</TooltipContent>
										</Tooltip>
									</div>
