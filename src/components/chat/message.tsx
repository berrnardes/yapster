			...
			>
				<div
					className={cn(
						...
						{
							"order-2 bg-sky-400 rounded-sm": message.isUserMessage,
				...
				>
					{message.isUserMessage ? (
						...
						<Icons.logo className="fill-zinc-300 text-zinc-100 h-3/4 w-3/4" />
					)}
				</div>
				...
				>
					<div
						className={cn("px-2 py-1.5 rounded-lg inline-block", {
							"bg-sky-400 text-white": message.isUserMessage,
